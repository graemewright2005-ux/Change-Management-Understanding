# Unit 552 - Task 3: Change Management Proposal

**Working document. Graeme Wright's dictated text, tidied.**
Proposal format. Target 3,000 words, ceiling 3,300, floor 2,700.
Excluded from count: headings, tables, graphs, figures, references, annexes.

## The change being proposed

Task 1 analysed a change that happened to the organisation. Task 3 proposes a change to be led.

**Proposed: embedding digital foundations across the college through the Digital Leads network.**
Securing accessible and inclusive digital practice as business as usual, so that the upper tiers of the Digital Skills Framework can subsequently be built on a compliant base. This is the change Graeme actually owns and is delivering now, which makes the proposal real rather than hypothetical.
...
- No em-dashes.
- Full reference inline at point of use, repeated in the bibliography.
- Nothing added without something coming out.
- Flag every inference drawn from dictation for confirmation or removal.
- Do not reuse Task 1 wording. Same evidence base, different argument, fresh sentences.
...
**Drafted - 698 words of prose plus three tables (budget 700).**
...
1. **Contradiction corrected.** Your dictation opened "specialist digital learning support was decentralised". Task 1 says the opposite: the restructure *concentrated* expertise into a single post, and distribution is the response. Written the Task 1 way. Confirm.
